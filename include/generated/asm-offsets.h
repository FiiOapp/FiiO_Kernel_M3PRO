...
#define TASK_MM 220 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 260 /* offsetof(struct task_struct, pid)	 # */
...
#define THREAD_BVADDR 944 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 948 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 952 /* offsetof(struct task_struct, thread.error_code)	 # */
...
#define VCPU_ARCH_SIZE 3416 /* sizeof(struct kvm_vcpu_arch)	 # */
#define VCPU_RUN 56 /* offsetof(struct kvm_vcpu, run)	 # */
#define VCPU_HOST_ARCH 240 /* offsetof(struct kvm_vcpu, arch)	 # */
